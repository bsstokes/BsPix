...
public class LikedMediaFragment extends Fragment implements MediaAdapter.OnClickListener, LikedMediaController.View {

    @NonNull public static LikedMediaFragment create() {
        return new LikedMediaFragment();
    }
    ...
    private LikedMediaController likedMediaController;

    public LikedMediaFragment() {
        // Default constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        likedMediaController = new LikedMediaController(this, bsPixDatabase);
        likedMediaController.load();
    ...
    @Override public void onClickMediaItem(@NonNull String mediaItemId) {
        likedMediaController.onClickMediaItem(mediaItemId);
    }
