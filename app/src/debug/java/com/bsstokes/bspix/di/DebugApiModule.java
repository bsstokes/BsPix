...
import static com.bsstokes.bspix.di.ApiModule.BASE_API_CLIENT;

@Module(includes = ApiModule.class)
class DebugApiModule {

    @Provides @Singleton @Named(ApiModule.API_CLIENT) OkHttpClient provideApiOkHttpClient(
    ...
    @Provides @Singleton StethoInterceptor provideStethoInterceptor() {
